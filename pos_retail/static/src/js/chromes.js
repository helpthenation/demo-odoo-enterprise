odoo.define('pos_retail.chromes', function (require) {
    ...
    chrome.OrderSelectorWidget.include({
        ...
        renderElement: function () {
            var self = this;
            this._super();
            if (!this.pos.config.allow_remove_order || this.pos.config.allow_remove_order == false || this.pos.config.staff_level == 'marketing' || this.pos.config.staff_level == 'waiter' || this.pos.config.staff_level == 'cashier') {
                this.$('.deleteorder-button').replaceWith('');
            }
            if (!this.pos.config.allow_add_order || this.pos.config.allow_add_order == false) {
