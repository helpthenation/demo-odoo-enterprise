odoo.define('pos_retail.pos_rounding', function(require) {
    ...
    screen.PaymentScreenWidget.include({
        ...
        payment_input: function(input){ // block input if selected line use rounding journal
            ...
            if (!(order.selected_paymentline && order.selected_paymentline.cashregister.journal && order.selected_paymentline.cashregister.journal.pos_method_type == 'rounding'))
                this._super(input);
        },
