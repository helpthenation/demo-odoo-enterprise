...
odoo.define('pos_retail.order', function (require) {
    ...
    models.Order = models.Order.extend({
        initialize: function (attributes, options) {
            ...
            if ((this.pos.version.server_serie == '10.0' || this.pos.version.server_serie == '10.0+e') && this.pos.default_pricelist) { // default price list for version 10
                if (!this.pricelist) {
        ...
        init_from_JSON: function (json) {
            ...
            if ((this.pos.version.server_serie == '10.0' || this.pos.version.server_serie == '10.0+e') && this.pos.default_pricelist) { // init price list for version 10
        ...
        export_as_JSON: function () {
            ...
            if ((this.pos.version.server_serie == '10.0' || this.pos.version.server_serie == '10.0+e') && this.pricelist) { // export price list for version 10
        ...
        active_button_add_wallet: function (active) {
            ...
            if (active) {
                ...
                $add_wallet.addClass('btn btn-success')
            } else {
        ...
        get_change: function (paymentline) {
            ...
            if (wallet_register) {
                ...
                if (change > 0 || (client && client['wallet'] > 0)) {
                    ...
                    $journal_element.addClass('btn btn-success');
                } else {
        ...
        add_product: function (product, options) {
            if (product['qty_available'] <= 0 && this.pos.config['allow_order_out_of_stock'] == false && product['type'] == 'product') {
                return this.pos.gui.show_popup('alert_result', {
                    title: 'Warning',
                    body: 'Product is out of stock, pos config not allow you add this product have out of stock',
                    timer: 3000
                });
            }
    ...
    models.Orderline = models.Orderline.extend({
        ...
        export_for_printing: function () {
            ...
            receipt_line['tax_amount'] = this.get_tax();
            return receipt_line;
        },
