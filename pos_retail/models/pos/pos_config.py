...
class pos_config(models.Model):
    ...
    pos_orders_management = fields.Boolean('POS order management', default=1)
    pos_order_period_return_days = fields.Float('POS order period days',
    ...
    discount = fields.Boolean('Active global discount', default=0)
    ...
    booking_orders = fields.Boolean('Booking orders', default=1)
    ...
    lock_session_password = fields.Char('Password unlock')
    ...
    pos_auto_invoice = fields.Boolean('Auto create invoice',
                                      ...
                                      default=0)
    receipt_invoice_number = fields.Boolean('Receipt Inv', help='Show invoice number on receipt header', default=1)
    receipt_customer_vat = fields.Boolean('Receipt VAT', help='Show customer VAT(TIN) on receipt header', default=1)
    auto_register_payment = fields.Boolean('Auto register payment', default=1)
    ...
    product_view = fields.Selection([
        ('box', 'Box view'),
        ('list', 'List view'),
    ], default='list', string='View of products screen', required=1)
    ...
    def clear_cache(self):
        ...
        self.env.cr.execute("UPDATE pos_bus_log SET state='done'")
        return True
